                                ...
                                <form action="{{route('admin.vendors.store')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="" placeholder="Enter Name">
                                            @error('name')
...
{{--                                        <select id="category_id" name="category_id[]" class="single-select" multiple>--}}
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input name="lat" type="number" class="form-control" id="">
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <label class="form-label">Put Longitude</label>
                                        <div class="form-group">
                                            <input name="lng" type="number" class="form-control" id="">
                                        </div>
                                    </div>
